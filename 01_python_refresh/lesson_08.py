...
def inspect_directory(
    ...
    try:
        ...
        return create_error_result(
            ...
            recursive,
            (
                f"Access denied while trying to access '{folder}'."
            ),
        )
    except FileNotFoundError:
        return create_error_result(
            folder,
            recursive,
            f"'{folder}' disappeared during the scan."
        ...
        return create_error_result(
            folder,
            recursive,
            f"Something went wrong while accessing '{folder}': {error}"
        )
    ...
    return {
        ...
        "file_types": Counter(dict(sorted(file_types.items()))),
